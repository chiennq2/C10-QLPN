...
public abstract class MasterDataWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
{
    protected static readonly Lazy<string> ContentRootFolder;

    static MasterDataWebTestBase()
    {
    ...
    protected override IWebHostBuilder CreateWebHostBuilder()
    {
        return base
            ...
            .UseSetting(WebHostDefaults.ApplicationKey, typeof(MasterDataWebMvcModule).Assembly.FullName);
    }
    ...
    {
        using (var context = IocManager.Resolve<MasterDataDbContext>())
        {
            action(context);
            context.SaveChanges();
        }
    ...
    protected async Task UsingDbContextAsync(Func<MasterDataDbContext, Task> action)
    {
        using (var context = IocManager.Resolve<MasterDataDbContext>())
        {
    ...
    protected async Task<T> UsingDbContextAsync<T>(Func<MasterDataDbContext, Task<T>> func)
    {
        T result;
