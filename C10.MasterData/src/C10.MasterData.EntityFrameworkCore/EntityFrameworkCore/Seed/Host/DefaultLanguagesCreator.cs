...
public class DefaultLanguagesCreator
{
    ...
    {
        var tenantId = MasterDataConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
    ...
    public DefaultLanguagesCreator(MasterDataDbContext context)
    {
        _context = context;
    }
